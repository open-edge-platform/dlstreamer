...
setup_gpu(){
    ...
    if [ "$ubuntu_version" == "24.04" ]; then
        ...
        install_packages intel-metrics-discovery=1.14.183-1~24.04~ppa1 intel-gsc=1.2.0-1~24.04~ppa1 libvpl2=1:2.16.0-1~24.04~ppa1 libze-intel-gpu1=26.18.38308.4-1~24.04~ppa3 libze1=1.28.2-1~24.04~ppa1 intel-opencl-icd=26.18.38308.4-1~24.04~ppa1 clinfo=3.0.23.01.25-1build1 \
