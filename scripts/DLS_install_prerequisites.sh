...
setup_gpu(){
    ...
    if [ "$ubuntu_version" == "24.04" ]; then
        ...
        install_packages clinfo=3.0.21.02.21-1 libze-intel-gpu1=25.18.33578.15-1146~22.04 libze1=1.21.9.0-1136~22.04 intel-media-va-driver-non-free=25.2.4-1146~22.04 intel-opencl-icd=25.18.33578.15-1146~22.04 || handle_error "Failed to install GPU drivers for Ubuntu 22.04"    else
