...
pip install --no-cache-dir --upgrade --extra-index-url https://download.pytorch.org/whl/cpu torch==2.13.0 torchaudio==2.8.0 torchvision==0.23.0 || handle_error $LINENO
