Develop an vision AI application that implements an event-based smart video recodring pipeline: 
...
- Run an AI model to detect people in cameara view
- Trigger reccording of a video stream to a local file when a person is detected and stop recording when person is out of view
