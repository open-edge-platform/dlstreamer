...
static void gst_gva_motion_detect_class_init(GstGvaMotionDetectClass *klass) {
    ...
    gst_element_class_set_static_metadata(
        ...
        "Operates on the luma plane; accepts NV12 / I420 / YV12 system-memory input and NV12 VAMemory input. Automatically uses VA surface path when VAMemory caps negotiated; otherwise system memory path", "dlstreamer");
