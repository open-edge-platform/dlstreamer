...
const std::vector<std::string> kHfSupportedArchitectures = {
    "ViTForImageClassification", "RTDetrForObjectDetection",      "RtDetrV2ForObjectDetection",
    "RfDetrForObjectDetection",  "RfDetrForInstanceSegmentation", "DepthAnythingForDepthEstimation"};
