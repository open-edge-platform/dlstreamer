 ...
 * Since: 1.26
 */
gboolean gst_analytics_relation_meta_add_keypoint_skeleton_mtd(GstAnalyticsRelationMeta *instance, const gsize skeleton_count,
 ...
 * Since: 1.26
 */
gboolean gst_analytics_relation_meta_add_keypointgroup_mtd(GstAnalyticsRelationMeta *instance, const gsize keypoint_count,
