...
Element Properties:
  ...
  core-pinning        : List or range of CPU cores to pin this inference element to (e.g., '0-3' or '0,2,3'). By default, the element uses the process CPU affinity mask. On Intel PTL-H series CPUs with all cores available, it automatically pins to the first 4 P-Cores for optimal performance.
                        flags: readable, writable
                        String. Default: null
