...
[samples/download_public_models.sh](https://github.com/open-edge-platform/dlstreamer/blob/v2026.0.0/samples/download_public_models.sh)
...
[supported models](https://github.com/open-edge-platform/dlstreamer/blob/v2026.0.0/samples/download_public_models.sh#L23).
