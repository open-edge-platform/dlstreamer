...
> **NOTE:** From [GStreamer 1.28](https://gstreamer.freedesktop.org/releases/1.28/) and [DL Streamer 2026.1.0] the VAAPI plugin support has being removed, the VA plugin must be used instead.
