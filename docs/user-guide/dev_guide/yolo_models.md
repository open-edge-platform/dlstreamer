...
> [download_ultralytics_models.py](https://github.com/open-edge-platform/dlstreamer/blob/v2026.1.0/scripts/download_models/download_ultralytics_models.py)
...
> **NOTE:** To obtain ready-to-use versions of the models described below, we recommend using the [`download_public_models.sh`](https://github.com/open-edge-platform/dlstreamer/blob/v2026.1.0/samples/download_public_models.sh) script. See [Download Public Models](./download_public_models.md) for details.
...
ovc yolov7.onnx
```
When used with `gvadetect`, this model requires `label-file=`[`coco_80cl.txt`](https://github.com/open-edge-platform/dlstreamer/blob/v2026.1.0/samples/labels/coco_80cl.txt) and `model-proc=`[`yolo-v7.json`](https://github.com/open-edge-platform/dlstreamer/blob/v2026.1.0/samples/gstreamer/model_proc/public/yolo-v7.json).

### Older YOLOv5 Versions

YOLOv5 models trained with `ultralytics/yolov5` are not compatible with the `ultralytics/ultralytics` library or the [download_ultralytics_models.py](https://github.com/open-edge-platform/dlstreamer/blob/v2026.1.0/scripts/download_models/download_ultralytics_models.py) script.
...
See [Samples](https://github.com/open-edge-platform/dlstreamer/tree/v2026.1.0/samples/gstreamer/gst_launch/detection_with_yolo) for detailed examples of Deep Learning Streamer pipelines using different YOLO models.
