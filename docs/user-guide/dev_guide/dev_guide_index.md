...
- [Performance Guide](./performance_guide.md)
  ...
  - [7. The Intel® DL Streamer Pipeline Framework performance benchmark results](./performance_guide.md#7-the-deep-learning-streamer-pipeline-framework-performance-benchmark-results)
