...
run
[download_omz_models.sh](https://github.com/open-edge-platform/dlstreamer/blob/v2026.0.0/samples/download_omz_models.sh)
and
[download_public_models.sh](https://github.com/open-edge-platform/dlstreamer/blob/v2026.0.0/samples/download_public_models.sh).
...
[sample directory](https://github.com/open-edge-platform/dlstreamer/tree/v2026.0.0/samples/gstreamer/gst_launch).
