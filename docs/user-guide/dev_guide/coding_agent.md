...
For the list of user prompts that can be tried with the DL Streamer coding agent, please check the ones available at [link](https://github.com/open-edge-platform/dlstreamer/tree/v2026.2.0/.github/skills/dlstreamer-coding-agent/example-prompts)
...
See the [example prompts in the DL Streamer Coding Agent repository](https://github.com/open-edge-platform/dlstreamer/tree/v2026.2.0/.github/skills/dlstreamer-coding-agent/example-prompts) for ready-to-use prompt templates, including:
