...
Refer to the
[vehicle_pedestrian_tracking](https://github.com/open-edge-platform/dlstreamer/tree/v2026.1.0/samples/gstreamer/gst_launch/vehicle_pedestrian_tracking) sample
