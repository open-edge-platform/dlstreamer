...
[header-only implementation](https://github.com/open-edge-platform/dlstreamer/blob/v2026.0.0/include/dlstreamer/gst/videoanalytics/tensor.h#L38)
...
[draw_face_attributes](https://github.com/open-edge-platform/dlstreamer/blob/v2026.0.0/samples/gstreamer/cpp/draw_face_attributes/main.cpp) C++ sample.
...
[sample](https://github.com/open-edge-platform/dlstreamer/tree/v2026.0.0/samples/gstreamer/gst_launch/gvapython/face_detection_and_classification).
...
[GVA::Tensor](https://github.com/open-edge-platform/dlstreamer/blob/v2026.0.0/include/dlstreamer/gst/videoanalytics/tensor.h#L38)
helper class.
...
[post-processor](https://github.com/open-edge-platform/dlstreamer/blob/v2026.0.0/src/monolithic/gst/inference_elements/common/post_processor/blob_to_meta_converter.cpp)
...
[sample](https://github.com/open-edge-platform/dlstreamer/tree/v2026.0.0/samples/gstreamer/gst_launch/custom_postproc).
...
- **Object Detection** (`GstAnalyticsODMtd`) - works only with the
   ...
   [detection_sample]: https://github.com/open-edge-platform/dlstreamer/tree/v2026.0.0/samples/gstreamer/gst_launch/custom_postproc/detect/
...
- **Classification** (`GstAnalyticsClsMtd`) - works with both the
  ...
  [classify_sample]: https://github.com/open-edge-platform/dlstreamer/tree/v2026.0.0/samples/gstreamer/gst_launch/custom_postproc/classify/
