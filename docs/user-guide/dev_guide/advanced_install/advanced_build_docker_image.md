...
> [pull docker images from DockerHub](../../install/install_guide_ubuntu.md#option-2-install-docker-image-from-docker-hub-and-run-it).
...
```bash
git clone -b v2026.2.0 https://github.com/open-edge-platform/dlstreamer.git
cd dlstreamer
...
[DL Streamer GitHub repository](https://github.com/open-edge-platform/dlstreamer/tree/v2026.2.0/docker).
