...
- [Advanced installation - compilation from source files](./advanced_install_guide_compilation.md)
  ...
  - [Step 4: Clone Deep Learning Streamer repository](./advanced_install_guide_compilation.md#step-4-clone-deep-learning-streamer-repository)
  - [Step 5: Install OpenVINO™ Toolkit](./advanced_install_guide_compilation.md#step-5-install-openvino-toolkit)
  - [Step 6: Install OpenVINO™ GenAI (only for Ubuntu)](./advanced_install_guide_compilation.md#optional-step-6-install-openvino-genai-only-for-ubuntu)
  - [Step 7: Build Intel® Deep Learning Streamer](./advanced_install_guide_compilation.md#step-7-build-deep-learning-streamer)
  - [Step 8: Install Deep Learning Streamer](./advanced_install_guide_compilation.md#step-8-install-deep-learning-streamer-optional)
  - [Step 9: Set up environment](./advanced_install_guide_compilation.md#step-9-set-up-environment)
  - [Step 10: Install Python dependencies](./advanced_install_guide_compilation.md#step-10-install-python-dependencies-optional)
- [Ubuntu advanced installation - build Docker image](./advanced_build_docker_image.md)
  ...
  - [Step 2: Clone DL Streamer repository](./advanced_build_docker_image.md#step-2-clone-dl-streamer-repository)
...
- [Windows advanced installation - compilation from source files](./advanced_install_guide_windows_compilation.md)
- [Windows advanced installation - install via command line](./advanced_install_guide_windows_command_line.md)
<!--hide_directive
:::{toctree}
:maxdepth: 2
:hidden:
...
advanced_install_guide_windows_compilation
advanced_install_guide_windows_command_line
:::
hide_directive-->