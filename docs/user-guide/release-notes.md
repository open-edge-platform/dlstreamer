...
| Availability of download_public_models.sh and download_omz_models.sh | end of Q3'2026 | new models downloading solution in `scripts/download_models` directory |
