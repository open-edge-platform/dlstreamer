...
repository in the [src folder](https://github.com/open-edge-platform/dlstreamer/tree/v2026.0.0/src)
and sub-folders.
...
[ffmpeg_openvino](https://github.com/open-edge-platform/dlstreamer/tree/v2026.0.0/samples/ffmpeg_openvino)
and
[ffmpeg_dpcpp](https://github.com/open-edge-platform/dlstreamer/tree/v2026.0.0/samples/ffmpeg_dpcpp)
for examples.
