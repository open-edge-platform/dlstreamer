...
[github](https://github.com/open-edge-platform/dlstreamer/tree/v2026.0.0/include/dlstreamer).
...
can be found by searching for the word `mapper` in [samples](https://github.com/open-edge-platform/dlstreamer/tree/v2026.0.0/samples)
and [src](https://github.com/open-edge-platform/dlstreamer/tree/v2026.0.0/src)
folders on github source code, like for example in the FFmpeg+DPCPP sample
[rgb_to_grayscale](https://github.com/open-edge-platform/dlstreamer/tree/v2026.0.0/samples/ffmpeg_dpcpp/rgb_to_grayscale)
