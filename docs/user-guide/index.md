...
<div class="component_card_widget">
  <a class="icon_github" href="https://github.com/open-edge-platform/dlstreamer/tree/v2026.1.0">
     GitHub
  </a>
  <a class="icon_document" href="https://github.com/open-edge-platform/dlstreamer/blob/v2026.1.0/README.md">
     Readme
  </a>
</div>
hide_directive-->
...
- [Deep Learning Streamer Pipeline
  Framework](https://github.com/open-edge-platform/dlstreamer/tree/v2026.1.0)
  for designing, creating, building, and running media analytics
  pipelines. It includes C++ and Python APIs.
- [Deep Learning Streamer Pipeline
  Server](https://github.com/open-edge-platform/edge-ai-libraries/tree/release-2026.1.0/microservices/dlstreamer-pipeline-server)
...
[70 NN Intel and open-source community pre-trained models](https://github.com/open-edge-platform/dlstreamer/blob/v2026.1.0/docs/scripts/supported_models.json), and models converted
...
included in
[Deep Learning Streamer Pipeline Framework](https://github.com/open-edge-platform/dlstreamer/tree/v2026.1.0),
[Deep Learning Streamer Pipeline Server](https://github.com/open-edge-platform/edge-ai-libraries/tree/release-2026.1.0/microservices/dlstreamer-pipeline-server),
