...
See
[model-proc](https://github.com/open-edge-platform/dlstreamer/tree/v2026.1.0/samples/gstreamer/model_proc)
...
[metapublish samples](https://github.com/open-edge-platform/dlstreamer/tree/v2026.1.0/samples/gstreamer/gst_launch/metapublish).
...
- [Samples overview](https://github.com/open-edge-platform/dlstreamer/blob/v2026.1.0/samples/gstreamer/README.md)
