...
| [g3dlidarparse](./g3dlidarparse.md) | Parses 3D LiDAR binary frames and attaches custom metadata with point cloud data. Expects application/octet-stream input.<br>Example:<br> gst-launch-1.0 filesrc location=lidar.bin ! application/octet-stream ! g3dlidarparse ! fakesink<br> |
