...
> **NOTE**: Prepare required models with `scripts/download_models/download_other_models.sh yolov8_license_plate_detector,ch_PP-OCRv4_rec_infer` before using this sample.
