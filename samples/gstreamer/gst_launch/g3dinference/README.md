...
- If you already downloaded the IR files with `scripts/download_models/download_other_models.sh pointpillars`, the preparation script reuses them from `MODELS_PATH/public/pointpillars/FP16`.
