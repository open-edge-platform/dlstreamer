...
DEEPSORT_CFG="max_age=90,max_cosine_distance=0.2,nn_budget=0,object_class=person,reid_max_age=30"
...
show_usage() {
    ...
    echo "                              (default: max_age=90,max_cosine_distance=0.2,nn_budget=0,object_class=person,reid_max_age=30)"
    echo ""
    echo "Deep SORT config parameters:"
    echo "  max_age              - Max frames a track survives without detection (default: 90)"
