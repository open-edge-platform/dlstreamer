...
| [VLM Self Checkout](./vlm_self_checkout/README.md) | <img src="./vlm_self_checkout/vlm_self_checkout.jpg" width="200" height="70"> | Demonstrates how to combine a CV object detection model running every frame with enhanced classification of selected frames using GenAI VLM model. The sample also shows how to create a custom  Python element to filter frames eligible for VLM processing. |
...
| [Watermark Meta](./watermark_meta/README.md) | <img src="./watermark_meta/watermark_meta_output.jpg" width="200" height="70"> | Demonstrates how to attach custom drawing primitives (polygons, lines, circles, text) to video frames using the DLStreamer watermark metadata API and render them with `gvawatermark`. |
| [ONVIF Camera Analytics Validation](./onvif_camera_analytics_validation/README.md) | <img src="./onvif_camera_analytics_validation/onvif_camera_analytics_validation_sample.png" width="200" height="70">  | Sample application that uses VLM with DL Streamer to provide an additional validation layer for ONVIF-enabled analytics cameras. |
| [GVAanalytics tripwire](./gvaanalytics_tripwire/README.md) | <img src="./gvaanalytics_tripwire/vehicle_counter_sample.jpg" width="200" height="70">  | Demonstrates how to use gvaanalytics with tripwire configuration to count tracked vehicles going left to right and right to left. |
| [Loitering detection](./loitering_detection/README.md) | <img src="./loitering_detection/loitering_detection_output.png" width="200" height="70"> | Demonstrates how to use gvaanalytics with zone region to measure object dwell time and render visual alert when dwell time threshold is exceeded. |
