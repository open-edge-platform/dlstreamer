...
| [Watermark Meta](./watermark_meta/README.md) | | Demonstrates how to attach custom drawing primitives (polygons, lines, circles, text) to video frames using the DLStreamer watermark metadata API and render them with `gvawatermark`. |
