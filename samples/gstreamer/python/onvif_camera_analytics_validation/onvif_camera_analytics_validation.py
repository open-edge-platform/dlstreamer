...
<style>
  *{margin:0;padding:0;box-sizing:border-box}
  ...
  .panel{background:#16213e;border-radius:8px;padding:16px;border:1px solid #0f3460;margin-bottom:16px}
  ...
  .vlm-text{font-size:15px;line-height:1.6;white-space:pre-wrap;color:#a8e6cf;min-height:60px}
  .event-data{font-size:13px;color:#ffd3b6;font-family:monospace;white-space:pre-wrap;max-height:200px;overflow-y:auto}
  .event-num{font-size:32px;font-weight:bold;color:#00d4ff;text-align:center;padding:16px 0}
...
<h1>ONVIF Analytics Validation &mdash; VLM</h1>
<div class="nav">
...
<div class="grid">
  ...
  <div class="panel">
    ...
    <div id="vlm" class="vlm-text waiting">Waiting for inference...</div>
  </div>
</div>
<div class="panel">
  <h2>MQTT Event</h2>
...
function showData(d,idx){
  ...
  if(d.vlm_text){el.textContent=d.vlm_text;el.className='vlm-text'}
  else{el.textContent='Waiting for inference...';el.className='vlm-text waiting'}
