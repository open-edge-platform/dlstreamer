...
VIDEO_FILE_NAME=${1}
MODEL1_PATH=${2:-"${MODELS_PATH}/public/centerface/FP16/centerface.xml"}
MODEL2_PATH=${3:-"${MODELS_PATH}/public/dima806_fairface_gender_image_detection/FP16/dima806_fairface_gender_image_detection.xml"}
